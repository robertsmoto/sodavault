    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ban_square', models.ImageField(blank=True, help_text='recommended size: 500px x 500px', null=True, upload_to=configapp.utils.images.user_file_path)),
                ('ban_leaderboard', models.ImageField(blank=True, help_text='recommended size: 728px x 90px', null=True, upload_to=configapp.utils.images.user_file_path)),
                ('ban_lg_leaderboard', models.ImageField(blank=True, help_text='recommended size: 970px x 90px', null=True, upload_to=configapp.utils.images.user_file_path)),
                ('ban_inline_rectangle', models.ImageField(blank=True, help_text='recommended size: 300px x 250px', null=True, upload_to=configapp.utils.images.user_file_path)),
                ('ban_lg_rectangle', models.ImageField(blank=True, help_text='recommended size: 336px x 280px', null=True, upload_to=configapp.utils.images.user_file_path)),
                ('ban_skyscraper', models.ImageField(blank=True, help_text='recommended size: 160px x 600px', null=True, upload_to=configapp.utils.images.user_file_path)),
