    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_featured', models.ImageField(blank=True, help_text='Recommended size: 1200 x 600px', null=True, upload_to=configapp.utils.utils_images.new_filename)),
                ('image_thumb', models.ImageField(blank=True, help_text='Recommended size: 500 x 500px', null=True, upload_to=configapp.utils.utils_images.new_filename)),
                ('image_191', models.ImageField(blank=True, help_text='1.9:1 ratio recommended size 1200px x 630px', null=True, upload_to=configapp.utils.utils_images.new_filename)),
